...
The facilitator reads three statements about AI. Students vote on which one is false.

Example set:
1. AI models can learn new information every time you use them. _(LIE — most models are frozen after training)_
2. Some AI models run entirely on your laptop with no internet. _(TRUE)_
3. A model trained mostly on English text will perform worse on other languages. _(TRUE)_
...
A machine learning model is a program that finds patterns in examples. It doesn't follow rules a human wrote — it figures out its own rules by looking at a huge amount of data.
...
- It does not "understand" meaning the way you do
- It does not look things up — it generates from patterns learned during training
- It can confidently produce something that is completely wrong

**Discussion prompt (5 min):** _"Does knowing this change how you feel about AI-generated content? Why or why not?"_

### Part 2 — Women Who Built This (40 min)

**Group research activity (25 min)**

Divide into small groups (3–4 students). Each group is assigned one of the following women and has 15 minutes to research and prepare a 2-minute presentation answering:
...
### Part 3 — Bias Is Not a Bug, It's a Mirror (35 min)
...
**Concept: Where does bias come from? (10 min)**
...
**Discussion prompt:** _"Can you think of an AI tool you use where bias might show up? What would it look like?"_

**Activity: The AI Audit Card (15 min)**
...
### Part 4 — Your Skepticism Is a Skill (20 min)

**Mini-lecture: Why AI needs critics (10 min)**
...
Give them a sentence starter if needed:
...
Facilitator shares 2–3 example statements (anonymized from previous cohorts, or written by the facilitator) to show the range of what this can look like.
...
5. Finish this sentence: _"My skepticism is valuable because..."_

## Take-Home

- Keep your AI Audit Card — bring it to Week 2
- Optional reading: [_Gender Shades_](https://www.media.mit.edu/projects/gender-shades/overview/) — the Joy Buolamwini study that documented facial recognition bias
- Optional: find one more woman in AI history not covered in class and bring her name to Week 2
