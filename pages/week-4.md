...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| **What you'll learn**       | By the end of this week you will be able to:<br>- Connect and initialize the Arducam Mini 2MP Plus camera with the Uno Q<br>- Capture a still image and transfer it over WiFi to your laptop<br>- Run MobileNet (from Week 2) on the laptop to classify the image<br>- Chain vision + language models: classification → LLM prompt → useful response<br>- Display multi-modal AI results on your laptop screen with LED feedback on the Uno Q |
| **Tools you'll need**       | Arduino Uno Q board, USB cable, Arducam Mini 2MP Plus (OV2640) camera, mini mouse, USB hub, laptop with Arduino App Lab installed, Python 3 with Flask + Pillow + TensorFlow, Ollama running (from Week 2), the Python server from Week 3 |
